...
scanner cont = P $ scan
    where
        ...
        mkIdOrKwd "threadStart"  = ThreadStart
        mkIdOrKwd "threadCancel" = ThreadCancel
        mkIdOrKwd "threadWait"   = ThreadWait
        mkIdOrKwd "threadLock"   = ThreadLock
        mkIdOrKwd "threadUnlock" = ThreadUnlock
